...
@Component({
  selector: 'app-tablamunicipal',
  templateUrl: './tablamunicipal.component.html',
  styleUrls: ['./tablamunicipal.component.css']
})
export class TablamunicipalComponent implements OnInit {
