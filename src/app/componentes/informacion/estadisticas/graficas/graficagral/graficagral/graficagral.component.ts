...
@Component({
  selector: 'app-graficagral',
  templateUrl: './graficagral.component.html',
  styleUrls: ['./graficagral.component.css']
})
export class GraficagralComponent implements OnInit {
  ...
  setGraficas(){
    this.datosService.getPacients('?$limit=2000000&$select=fecha_de_notificaci_n, ciudad_de_ubicaci_n, departamento, atenci_n, edad, sexo, tipo, estado, pa_s_de_procedencia, fecha_de_muerte, fecha_diagnostico, fecha_recuperado, tipo_recuperaci_n').subscribe((pacietsAPI: Paciente[]) =>{
...
//Fin diseño gráfica de tipo de recuperación
    ...
    /*pacietsAPI.forEach(res => console.log(res.tipo_recuperaci_n)); */
    /* console.log('N/A: '+ this.contEN);
    console.log('Casa: '+ this.contAC);
    console.log('UCI: '+ this.contAU);
    console.log('Fallecidos: '+ this.contAF);
    console.log('Hospital: '+ this.contAH);
    console.log('N/A: '+ this.contAN); */
