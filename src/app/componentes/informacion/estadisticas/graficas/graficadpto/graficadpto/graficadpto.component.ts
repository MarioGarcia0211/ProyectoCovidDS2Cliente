...
@Component({
  selector: 'app-graficadpto',
  templateUrl: './graficadpto.component.html',
  styleUrls: ['./graficadpto.component.css']
})
export class GraficadptoComponent implements OnInit {
...
//Limpiar campo de texto y poner en el campo correspondiente
